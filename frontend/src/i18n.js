const translations = {
  en: {
    ...
    shareRiotIdHint: 'Hidden by default. A public Riot ID can be used to target your account.',
  ...
  vn: {
    ...
    shareRiotIdHint: 'Mặc định ẩn. Riot ID công khai có thể bị người khác dùng để nhắm vào tài khoản của bạn.',
